...
public class TakeItemEntityPacket implements BedrockPacketTranslator {
    ...
    public void translate(BedrockPacket pk, Player player) {
        ...
        player.javaSession.send(new ClientboundRemoveEntitiesPacket(entityIds));
        player.javaSession.send(new ClientboundTakeItemEntityPacket((int) packet.getItemRuntimeEntityId(), (int) packet.getRuntimeEntityId(), 1));
    }
}
